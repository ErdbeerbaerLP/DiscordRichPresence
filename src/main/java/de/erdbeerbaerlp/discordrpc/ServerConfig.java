...
public class ServerConfig {
	...
	ServerConfig(ForgeConfigSpec.Builder builder) {
		...
		SERVER_MESSAGE = builder.comment(
				"The second line you have in the rich presence.\n Placeholders are:\n%players% - Amount of all players\n%otherpl% - Amount of players -1 (except you)")
				.define("Message", "Playing on a random Server with %otherpl% other players");
		SERVER_ICON = builder.comment("The Icon-Key. Use 'world' or 'cube' if you don�t have an special one.")
				.define("IconKey", "world");
